...
declare module 'lightweight-pixi-engine' {
    import "./prototypes";
    import "./interfaces";
    import "./containerTransitions";
    import { ICharm } from "pixijs-charm";
    import "fpsmeter";
    import { ISceneManager } from "lightweight-pixi-engine/sceneManager";
    /**
...
declare module 'lightweight-pixi-engine/sceneManager' {
